...
const BasicExample = () => (
  <div>
    ...
    <p>
      ...
      <kbd>FormControl</kbd> components are set to width: 100%; by default. Wrap labels and controls
      in <kbd>FormGroup</kbd> for optimum spacing.
    </p>
    <p className={`m-t-2 ${classes.sectionLabel}`}>Example</p>
    <Panel>
      <Row>
        <Col sm={4}>
          <Form>
            ...
            <FormGroup controlId="formBasicFile">
              <ControlLabel>FileInput</ControlLabel>
              <FormControl type="file" />
              <p>Example block-level help text here.</p>
            </FormGroup>
            <Form.Check>Check me out</Form.Check>
  ...
  <div>
    ...
    <Panel>
      <Form inline>
        <FormGroup controlId="inlineUserName">
          <ControlLabel className="m-r-1">Name</ControlLabel>
          <FormControl type="text" placeholder="Jane Doe" />
        </FormGroup>
        <FormGroup controlId="inlineUserEmail" className="m-r-1">
          <ControlLabel className="m-x-1">Email</ControlLabel>
    ...
    <Panel>
      <Form inline>
        ...
        <Form.Check className="m-x-1">{' Remember me'}</Form.Check>
    ...
    <Panel>
      <Form inline>
        ...
        <Button bsStyle="primary">Transfer cash</Button>
      </Form>
    </Panel>
  </div>
);
...
const HorizontalExample = () => (
  <div>
    ...
    <p>
      ...
      horizontal layout by adding <kbd>horizontal</kbd> to the <kbd>Form</kbd>.
    </p>
    <p className={`m-t-2 ${classes.sectionLabel}`}>Example</p>
    <Panel>
      <Row>
