          ...
          <ListGroupItem className={classes['list-item']} key={index}>
            ...
            <Media>
              <Media.Body className="text-right">
                <p className="m-y-0">{moment(file.modifiedDate).format('DD-MMM-YYYY')}</p>
                <p className="m-y-0">{moment(file.modifiedDate).format('HH:mm')}</p>
              </Media.Body>
          ...
          <Col lg={3} md={6} key={index}>
            <Panel className={classes['grid-panel']} fullBody>
              ...
              <div className="p-l-1">
                ...
                <p className="m-y-1">{moment(file.modifiedDate).format('DD-MMM-YYYY, HH:mm')}</p>
              </div>
            </Panel>
          </Col>
        ))}
      ...
      <div className="m-t-3">
        <div className={classes['divider']}>
          <Divider className={classes['divider--line']}>
            Attachments
            <Badge className="m-l-1">{this.state.files.length}</Badge>
          </Divider>
        ...
        <Row>
          <Col lg={12}>
            ...
            <p className="small text-uppercase text-muted">
              <strong>Example demonstrating drag nad drop of native files</strong>
            </p>
            ...
            >
              ...
              <h4 className="m-t-0">Upload Your files</h4>
              <p>
