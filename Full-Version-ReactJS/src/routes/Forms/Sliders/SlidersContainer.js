        ...
        <Row>
          <Col lg={12}>
            {/*
                            ...
                            ******************************
                        */}
            <h4 className="m-b-2">Marks</h4>
            <Row>
              <Col lg={6}>
                <p>
                  Slider with marks, <kbd>step=null</kbd>
                </p>
              ...
              <Col lg={6}>
                <p>
                  Slider with marks, <kbd>included=false</kbd>
                </p>
                <div className={classes.markedSliderWrap}>
              ...
              <Col lg={6}>
                <p>
                  Slider with marks and steps, <kbd>included=false</kbd>
                </p>
                <div className={classes.markedSliderWrap}>
            ...
            {/*
                            ...
                            ******************************
                        */}
            <h4 className="m-b-2">Range</h4>
            <Row>
              <Col lg={6}>
                <p>
                  Basic Range，<kbd>allowCross=false</kbd>
                </p>
              ...
              <Col lg={6}>
                <p>
                  Basic Range，<kbd>step=20, dots</kbd>{' '}
                </p>
                <div className={classes.rangeSliderWrap}>
              ...
              <Col lg={6}>
                <p>
                  Range with dynamic <kbd>max</kbd> <kbd>min</kbd>
                </p>
                <div className={classes.rangeSliderWrap}>
                  <DynamicBounds>
            ...
            <Row>
              ...
              <Col lg={6}>
                <p>
                  Basic Slider，<kbd>step=20, dots</kbd>
                </p>
                <div className={classes.rangeSliderWrap}>
            ...
            {/*
                            ...
                            ******************************
                        */}
            <h4 className="m-b-2">Vertical Sliders</h4>
            <Row>
              <Col lg={3}>
                <p>
                  Slider with marks, <kbd>step=null</kbd>
