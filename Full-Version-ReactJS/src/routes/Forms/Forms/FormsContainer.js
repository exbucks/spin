...
const BasicElements = () => (
  <Row>
    <Col lg={6}>
      <h4 className="m-t-3">Basic Elements</h4>
      <p className="m-b-2">Individual form controls automatically receive some global styling.</p>
      <p className={classes.sectionLabel}>Example</p>
      <Form horizontal>
...
const CheckboxesRadios = () => (
  <Row>
    <Col lg={6}>
      <h4 className="m-t-3">Checkboxes & Radios</h4>
      <p className="m-b-2">
      ...
      <Form horizontal>
        <FormGroup controlId="formCheckRadioBasic">
          ...
          <Col sm={9}>
            <Form.Check>Option one is this and that—be sure to include why it's great</Form.Check>
            <Form.Check disabled>Option two is disabled</Form.Check>
        ...
        <FormGroup controlId="formCheckRadioInline">
          ...
          <Col sm={9}>
            <p className="m-y-0">
              <Form.Check inline>One</Form.Check>
              <Form.Check inline>Two</Form.Check>
              <Form.Check inline>Three</Form.Check>
            </p>
            <p className="m-y-0">
        ...
        <FormGroup controlId="formCheckRadioValidationHelpers">
          ...
          <Col sm={9}>
            <Form.Check validationState="success">Checkbox with Success</Form.Check>
            <Form.Check validationState="warning">Checkbox with Warning</Form.Check>
            <Form.Check validationState="error">Checkbox with Error</Form.Check>
          </Col>
        </FormGroup>
      </Form>
    </Col>
...
const Sizing = () => (
  <Row>
    <Col lg={12}>
      <h4 className="m-t-3">Sizing</h4>
      <p>
        Use the <kbd>bsSize</kbd> prop to change the sizing of <kbd>FormControl</kbd> or{' '}
        <kbd>InputGroup</kbd>
      </p>
      <p className={classes.sectionLabel}>Example</p>
      <Row>
...
const AdditionalElements = () => (
  <Row>
    <Col lg={12}>
      <h4 className="m-t-3">Form Elements Options</h4>
      <p>
        Extend form controls by adding text or buttons before, after, or on both sides of any
        text-based input
      </p>
      <p className={classes.sectionLabel}>Basic Examples</p>
      <Row>
        <Col lg={6}>
          <FormGroup>
            <InputGroup>
    ...
    <Col lg={12} className="m-t-3">
      <Row>
        ...
        <Col lg={4}>
          <p className={classes.sectionLabel}>With Dropdowns</p>
          <FormGroup>
            <InputGroup>
              <InputGroup.Button>
        ...
        <Col lg={4}>
          <p className={classes.sectionLabel}>Segmented Buttons</p>
          <FormGroup>
            <InputGroup>
              <InputGroup.Button>
...
const ValidationStates = () => (
  <Row>
    <Col lg={12}>
      <h4 className="m-t-3">Validation States</h4>
      <p>
      ...
      <Row>
        ...
        <Col lg={6}>
          <p className={classes.sectionLabel}>Validation States with Icons</p>
          <FormGroup controlId="formValidationSuccess" validationState="success">
            <ControlLabel>Input with Success</ControlLabel>
            <InputGroup>
              <InputGroup.Addon>@</InputGroup.Addon>
...
const MaskedInputs = () => (
  <Row>
    <Col lg={12}>
      <h4 className="m-t-3">Text Mask</h4>
      <p>
        This is a demo of{' '}
        <a
          href="https://github.com/text-mask/text-mask/tree/master/react/example"
          target="_blank"
          rel="nofollow"
        >
          Text Mask
        </a>
        &nbsp;Try filling out the masked input field. Try entering bad characters, pasting, deleting
        ot using auto-fill. Try it on mobile too.
      </p>
      ...
      <Row>
        ...
        <Col lg={4}>
          <FormGroup controlId="maskedEmail">
            ...
            <MaskedTextInput mask={emailMask} placeholder="john@smith.com" />
          </FormGroup>
        </Col>
        <Col lg={4}>
          <FormGroup controlId="maskedUsZipCode">
            <ControlLabel>US Zip Code</ControlLabel>
            <MaskedTextInput mask={[/[1-9]/, /\d/, /\d/, /\d/, /\d/]} placeholder="94303" />
          </FormGroup>
        </Col>
...
class Switches extends React.Component {
  ...
  render() {
    return (
      <Row>
        <Col lg={12}>
          <h4 className="m-t-3">Switches</h4>
          <p>An elegant, accessible toggle component for React. Also a glorified checkbox.</p>
          <Row>
            <Col lg={6}>
              <Table>
                <thead>
    ...
    return (
      <div className={classes.mainWrap}>
        <Row>
          <Col lg={12}>
            <p>
              The <kbd>FormControl</kbd> component renders a form control with Bootstrap styling.
              The <kbd>FormGroup</kbd> component wraps a form control with proper spacing, along
              with support for a label, help text, and validation state. To ensure accessibility,
              set controlId on <kbd>FormGroup</kbd>, and use <kbd>ControlLabel</kbd> for the label.
            </p>
            <BasicElements />
            <CheckboxesRadios />
            <Sizing />
