...
const sdpInputPropsVariants = [
  {
    key: 'sdpip-default',
    menuTitle: 'default',
    component: () => <SingleDatePickerWrapper initialDate={moment().add(3, 'days')} />
  },
  {
    key: 'sdip-clear-button',
    menuTitle: 'with clear dates button',
    component: () => <SingleDatePickerWrapper initialDate={moment().add(3, 'days')} showClearDate />
  },
  {
  ...
  },
  {
    ...
    component: () => (
      <SingleDatePickerWrapper initialDate={moment().add(3, 'days')} displayFormat="MMM D" />
    )
  },
  {
