    ...
    component: () => (
      <Form inline>
        <FormGroup controlId="bootstrap-drp-input-separator">
          <DateRangePicker prefixAddOn={false} postfixButton={false} bsSize="lg" />
          <DateRangePicker prefixAddOn={false} postfixButton={false} className="m-t-3" />
          <DateRangePicker
            prefixAddOn={false}
            postfixButton={false}
            bsSize="sm"
    ...
    component: () => (
      <Form inline>
        <FormGroup controlId="bootstrap-drp-buttons">
          <DateRangePicker type="button" bsSize="lg" bsStyle="primary" bsStyleActive="success" />

          <DateRangePicker type="button" bsStyle="link" bsStyleActive="primary" className="m-t-3" />
