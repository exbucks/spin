...
const drpCalendarPropsVariants = [
  {
    key: 'drpcp-default',
    menuTitle: 'default',
    component: () => <DateRangePickerWrapper autoFocus />
  },
  {
    key: 'drpcp-single-month',
    menuTitle: 'single month',
    component: () => <DateRangePickerWrapper numberOfMonths={1} autoFocus />
  },
  {
    key: 'drpcp-3-months',
    menuTitle: '3 months',
    component: () => <DateRangePickerWrapper numberOfMonths={3} autoFocus />
  },
  {
    key: 'drpcp-achored-right',
    menuTitle: 'anchored right',
    component: () => <DateRangePickerWrapper anchorDirection={ANCHOR_RIGHT} autoFocus />
  },
  {
    key: 'drpcp-vertical',
    menuTitle: 'vertical',
    component: () => <DateRangePickerWrapper orientation={VERTICAL_ORIENTATION} autoFocus />
  },
  {
  ...
  },
  {
    ...
    component: () => <DateRangePickerWrapper withPortal autoFocus />
  },
  {
    key: 'drpcp-horizontal-w-fullscreen-portal',
    menuTitle: 'horizontal with fullscreen portal',
    component: () => <DateRangePickerWrapper withFullScreenPortal autoFocus />
  },
  {
  ...
  },
  {
    ...
    component: () => <DateRangePickerWrapper keepOpenOnDateSelect autoFocus />
  },
  {
  ...
  },
  {
    ...
    component: () => <DateRangePickerWrapper numberOfMonths={1} enableOutsideDays autoFocus />
  },
  {
