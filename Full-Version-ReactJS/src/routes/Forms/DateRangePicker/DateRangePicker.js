        ...
        <Col lg={8}>
          {_.contains(VariantDayPickerRangeController, variantToRender) && (
            <p className="text-justify m-b-3">
              The <kbd>DayPickerRangeController</kbd> component is a fully controlled version of the{' '}
              <kbd>DayPicker</kbd> that has built-in rules for selecting a date range. Unlike the{' '}
              <kbd>DayPicker</kbd>, which requires the consumer to explicitly define
              ...
              <kbd>startDate</kbd>, and <kbd>endDate</kbd> values in state and then pass these down
              as props along with <kbd>onFocusChange</kbd> and <kbd>onDatesChange</kbd> callbacks
              that update them appropriately. You can see an example of this implementation{' '}
              <a href="https://github.com/airbnb/react-dates/blob/master/examples/DayPickerRangeControllerWrapper.jsx">
                here
              </a>
              . <br />
              <br />
              ...
              <kbd>focusedInput</kbd> to be truthy in the <kbd>onFocusChange</kbd>. <br />
              <br />
              The <kbd>DayPickerRangeController</kbd> is particularly useful if you are interested
              in the
