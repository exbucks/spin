...
const PricingTableClean = (props) => (
  <div className={classes.tableClean}>
    ...
    <div>
      <p className={classes.price}>${numeral(props.price).format('0.00')}</p>
      <p>/ month</p>
    </div>
    <Divider textPosition="center">Description</Divider>
    <p className={classes.description}>{props.description}</p>
    <Divider textPosition="center">Capabilities</Divider>
...
const PricingTable = (props) => (
  <Panel
    header={
      <div className={classes.header} style={{ backgroundColor: typeToColor(props.bsStyle) }}>
