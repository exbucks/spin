...
class ReactTables extends RoutedComponent {
  ...
  render() {
    return (
      <div>
        <p>
          React-bootstrap-table is a React component for Bootstrap table. It's a configurable,
          functional table component.It make you build a Bootstrap Table more efficiency and easy in
