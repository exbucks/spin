    ...
    return (
      ...
      >
        ...
        >
          Product ID
          <br />
          <a onClick={this.handlerClickCleanFiltered.bind(this)} style={{ cursor: 'pointer' }}>
        ...
        <TableHeaderColumn
          ref="quality"
          dataField="quality_id"
          filter={{ type: 'SelectFilter', options: qualityNames }}
          dataFormat={qualityFormatter}
          formatExtraData={qualityNames}
          dataSort
        >
          Product Quality
        </TableHeaderColumn>
        ...
        <TableHeaderColumn
          ...
          dataFormat={satisfactionFormatter}
          dataSort
        >
          Buyer Satisfaction
        </TableHeaderColumn>
