      ...
      <div className="flex-space-between">
        ...
        <ButtonToolbar>
          ...
          <Button bsStyle="primary">
            ...
            <span className="visible-lg-inline">{' Send'}</span>
          </Button>
        </ButtonToolbar>
      </div>
    }
    ...
    <div>
      <Row>
        <Col md={12} className="m-b-1">
          <InputGroup>
            ...
            <FormControl type="email" placeholder="Enter email(s)..." />
            <InputGroup.Button>
              <Button>
      ...
      <Row>
        <Col md={6} className="m-b-1">
          <InputGroup>
            <InputGroup.Addon>Cc</InputGroup.Addon>
            <FormControl type="text" placeholder="Enter email(s)..." />
          </InputGroup>
        </Col>
        <Col md={6} className="m-b-1">
          <InputGroup>
            <InputGroup.Addon>Bcc</InputGroup.Addon>
            <FormControl type="text" placeholder="Enter email(s)..." />
          </InputGroup>
        </Col>
      </Row>
      <Row>
        <Col md={12} className="m-b-1">
          <InputGroup>
            ...
            <FormControl type="text" placeholder="Enter topic..." />
          </InputGroup>
        </Col>
      </Row>
      <Row>
        <Col md={12} className="m-b-1">
          <FormControl componentClass="textarea" placeholder="Enter message..." rows={6} />
        </Col>
      </Row>
    </div>
