...
const renderNavigation = () => (
  <div>
    <p className={classes.navigiationDivider}>Navigate</p>
    <Nav bsStyle="pills" stacked activeKey={1} className="m-b-2">
    ...
    <p className={classes.navigiationDivider}>Help</p>
    <Nav bsStyle="pills" stacked className="m-b-3">
      <NavItem eventKey={1} href="javascript:;">
        FAQ
      </NavItem>
      <NavItem eventKey={2} href="javascript:;">
    ...
    <p className={classes.navigiationDivider}>Policies</p>
  ...
  <Row className="m-t-3">
    <Col lg={4}>
      <Panel className="text-center">
        ...
        <p>
          Have a general questions that's not answered in our Articles? We will get back to you
          asap.
        </p>
    ...
    <Col lg={4}>
      <Panel className="text-center">
        ...
        <p>Login to your Dashboard account for technical questions relative to themes & plugins.</p>
    ...
    <Col lg={4}>
      <Panel className="text-center">
        ...
        <p>
          You get this dashboard & need a bit of customization work completed? We can makie it
          happen.
        </p>
...
const renderAccordions = () => {
  ...
  return (
    <Row>
      <Col lg={6}>
        <h4 className="m-b-2">Getting Started</h4>
        <Accordion>
        ...
        <h4 className="m-b-2 m-t-3">Updates</h4>
        <Accordion>
...
class FaqContainer extends RoutedComponent {
  ...
  render() {
    return (
      <Row>
        <Col lg={2}>{renderSection(renderNavigation)}</Col>
        <Col lg={10}>
          <div className="text-center">
            <h4 className="display-4 m-t-0">Frequently Asked Questions</h4>
            <p>Get Help. Find Answers.</p>
          </div>
          ...
          <Row>
            <Col lg={4} lgOffset={4} className="m-y-3">
              <InputGroup>
                ...
                <InputGroup.Button>
                  <Button bsStyle="primary">Find Help</Button>
                </InputGroup.Button>
              </InputGroup>
            </Col>
          </Row>
          ...
          <Divider textPosition="center" className="m-b-2 m-t-3">
            Articles
          </Divider>
