  ...
  render() {
    return (
      <div>
        <Panel
          className="m-b-2"
          header={<h4 className="panel-title">Billing Edit</h4>}
          footer={
            <div>
              <i className="fa fa-fw fa-support m-r-1"></i>
              If you want to personalize the notification settings,{' '}
              <Link to="/apps/user-profile/edit/settings">go here.</Link>
            </div>
          }
        >
          <Form horizontal>
            <Media>
              <Media.Body>
                <FormGroup>
                  ...
                  <Col sm={6}>
                    <p>
                      <span className="text-white">Premium</span> - You use 37% of the available
                      space
                    </p>
                    ...
                    <dl className="dl-horizontal m-t-1">
                      ...
                      <dd className="text-white">214,8 GB / 1,03 TB</dd>
        ...
        <Panel header={<h4 className="panel-title">Payment History</h4>}>
          <Table fill>
            <thead>
              <tr>
                <th>#</th>
            ...
            <tbody>
              <tr>
                <td>
                  <OverlayTrigger
                    overlay={<Tooltip id="payment-status-tooltip-1">Success</Tooltip>}
                  >
                    <i className="fa fa-check text-success"></i>
                  </OverlayTrigger>
                </td>
                <td className="text-white">26822</td>
                <td className="text-white">2016-04-21</td>
                <td className="text-white">$ 626.00</td>
                <td>
                ...
                <td>
                  ...
                  <span className="text-white">{payPalUserName1}</span>
                </td>
                <td>
                  <OverlayTrigger overlay={<Tooltip id="download-link-1">Download</Tooltip>}>
                    <a href="javascript:;">
              ...
              <tr>
                <td>
                  <OverlayTrigger
                    overlay={<Tooltip id="payment-status-tooltip-2">Success</Tooltip>}
                  >
                    <i className="fa fa-check text-success"></i>
                  </OverlayTrigger>
                </td>
                <td className="text-white">75314</td>
                <td className="text-white">2011-09-13</td>
                <td className="text-white">$ 379.00</td>
                <td>
                ...
                <td>
                  ...
                  <span>Visa 4*** **** **** 9221</span>
                </td>
                <td>
                  <OverlayTrigger overlay={<Tooltip id="payment-link-tooltip-2">Download</Tooltip>}>
                    <a href="javascript:;">
                      <i className="fa fa-cloud-download"></i>
                    </a>
                  </OverlayTrigger>
              ...
              <tr>
                <td>
                  <OverlayTrigger overlay={<Tooltip id="payment-status-tooltip-3">Failed</Tooltip>}>
              ...
              <tr>
                <td>
                  <OverlayTrigger overlay={<Tooltip id="payment-status-tooltip-4">Failed</Tooltip>}>
                    <i className="fa fa-close text-danger"></i>
                  </OverlayTrigger>
                </td>
                <td>38264</td>
              ...
              <tr>
                <td>
                  <OverlayTrigger
                    overlay={<Tooltip id="payment-status-tooltip-5">Success</Tooltip>}
                  >
                    <i className="fa fa-check text-success"></i>
                  </OverlayTrigger>
                </td>
                ...
                <td>$ 793.00</td>
                <td>
                  <Label outline>Free</Label>
                </td>
                <td>
                  <i className="fa fa-fw fa-paypal m-r-1"></i>
                  <span className="text-white">{payPalUserName3}</span>
                </td>
                <td></td>
              </tr>
            </tbody>
        ...
        >
          ...
          <Modal.Footer>
            <p className="m-y-0">
              ...
              <a href="javascript:;">Downgrade Now</a>
            </p>
          </Modal.Footer>
        </Modal>
        ...
        >
          ...
          <Modal.Body>
            <form>
              <FormGroup>
                <h5 className={classes.paymentOtherLabel}>Pay With</h5>
                <Form.Check
                  inline
                  type="radio"
              ...
              {this.state.paymentModalType === 'credit' ? (
                <div>
                  <FormGroup>
                    <h5 className={classes.paymentOtherLabel}>Credit Card Number</h5>
                    <FormControl type="text" placeholder="Enter Your Card Number..." />
                  </FormGroup>

                  <FormGroup>
                    <h5 className={classes.paymentOtherLabel}>Accepted Cards</h5>
                  ...
                  <Row>
                    <Col xs={7}>
                      <FormGroup inline>
                        <h5 className={classes.paymentOtherLabel}>Expiriation</h5>
                    ...
                    <Col xs={5}>
                      <FormGroup>
                        <h5 className={classes.paymentOtherLabel}>CVV</h5>
          ...
          <Modal.Footer>
            <Button className="m-r-1" onClick={() => this.setState({ paymentModalOpen: false })}>
              Cancel
            </Button>
