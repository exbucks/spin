            ...
            <Media>
              ...
              <Media.Body>
                <p className="h3 m-y-0">
                  <Link to="/apps/profile-details">{userToEdit.Name}</Link>
                  <span className="text-muted m-x-1">/</span>
                  <span className="text-white">{urlSectionToName(sectionName)}</span>
                </p>
                <p className="m-y-0">
                  <Label outline className="m-r-1 v-a-m" bsStyle="primary">
                    Premium
                  </Label>
                  <span className="v-a-m">Edit Your Name, Avatar, etc.</span>
                </p>
              </Media.Body>
            </Media>
          </Col>
          ...
          <Col lg={2}>
            <Nav bsStyle="pills" stacked>
              ...
              <LinkContainer to="/apps/user-profile/edit/sessions">
                <NavItem eventKey={5} href="javascript:;">
                  Sessions Edit
                </NavItem>
              </LinkContainer>
            </Nav>
