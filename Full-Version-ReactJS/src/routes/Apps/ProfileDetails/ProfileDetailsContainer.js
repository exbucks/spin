...
const renderUser = () => (
  <div className={classes.userDetails}>
    <Media>
      ...
      <Media.Body>
        <div className={classes.userPanelName}>
          <h4>{User.name}</h4>
          <FavoriteStar favorited={!!parseInt(User.favoritted)} className="m-l-1" />
        </div>
        <p>{User.position}</p>
        <div>
    ...
    <p className="m-y-0">{User.shortProfile}</p>
