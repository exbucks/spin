    ...
    <Modal.Body className="text-center">
      <Row>
        <Col md={6} className="text-center">
          ...
          />
          <h4 className="m-y-2">{callerData.Caller.Name}</h4>
          <p>{callerData.Caller.Position}</p>
        </Col>
        <Col md={6}>
          <Image
            phIcon={<i className="fa fa-video-camera fa-4x"></i>}
          ...
          />
          <h4 className="m-y-2">{callerData.Callee.Name}</h4>
          <p>{callerData.Callee.Position}</p>
        </Col>
        <Col md={12}>
          <Divider textPosition="center">Contact Options</Divider>
          <div className="text-center m-y-1">
            <a href="javascript:;" className="p-x-1">
              <OverlayTrigger placement="top" overlay={<Tooltip id="call-button">Call</Tooltip>}>
            ...
            <a href="javascript:;" className="p-x-1">
              <OverlayTrigger
                placement="top"
                overlay={<Tooltip id="dismiss-button">Dismiss</Tooltip>}
              >
                <span className="fa-stack fa-lg">
            ...
            <a href="javascript:;" className="p-x-1">
              <OverlayTrigger placement="top" overlay={<Tooltip id="chat-button">Chat</Tooltip>}>
                <span className="fa-stack fa-lg">
            ...
            <a href="javascript:;" className="p-x-1">
              <OverlayTrigger
                placement="top"
                overlay={<Tooltip id="voice-only-button">Voice Only</Tooltip>}
              >
                <span className="fa-stack fa-lg">
