      ...
      <div style={{ paddingTop: !this.props.headerEnabled ? '19px' : '0' }}>
        ...
        >
          <div className={classes.headerContent}>
            <Button bsStyle="primary" bsSize="sm" outline onClick={() => this.resetLayout()}>
              Reset Layout
            </Button>
          </div>
        </Header>
        ...
        <Grid fluid={this.props.contentView !== CONTENT_VIEW_STATIC}>
          {!this.props.headerEnabled && (
            <div className="text-right">
              <Button bsStyle="primary" onClick={() => this.resetLayout()}>
                Reset Layout
              </Button>
            </div>
          )}
              ...
              >
                ...
                {this.isPanelOpen('timeline_1') && (
                  <FloatGrid.Col {...this.getColumnDef('timeline-1')}>
                    <Timeline title="Timeline #1" onClose={() => this.closePanel('timeline_1')}>
                      <TimelineExample1 />
                    </Timeline>
                  </FloatGrid.Col>
                )}
              ...
              >
                ...
                {this.isPanelOpen('timeline_2') && (
                  <FloatGrid.Col {...this.getColumnDef('timeline-2')}>
                    <Timeline title="Timeline #2" onClose={() => this.closePanel('timeline_2')}>
                      <TimelineExample2 />
                    </Timeline>
                  </FloatGrid.Col>
                )}
                {this.isPanelOpen('timeline_3') && (
                  <FloatGrid.Col {...this.getColumnDef('timeline-3')}>
                    <Timeline title="Timeline #3" onClose={() => this.closePanel('timeline_3')}>
                      <TimelineExample3 />
                    </Timeline>
                  </FloatGrid.Col>
                )}
