      ...
      <ListGroupItem>
        <Row>
          <Col xs={6}>
            ...
            <p className="text-white h3 m-y-0">3789</p>
          </Col>
          <Col xs={6}>
            <p className="m-y-0 small">
            ...
            <p className="text-white h3 m-y-0">5467</p>
          </Col>
          <Col xs={12}>
      ...
      <ListGroupItem>
        <Row>
          <Col xs={6}>
            ...
            <p className="text-white h3 m-y-0">45</p>
          </Col>
          <Col xs={6}>
            <p className="m-y-0 small">
            ...
            <p className="text-white h3 m-y-0">123</p>
          </Col>
          <Col xs={12}>
            <SlimProgressBar className="m-y-1">
      ...
      <ListGroupItem>
        <Row>
          <Col xs={6}>
            ...
            <p className="text-white h3 m-y-0">55</p>
          </Col>
          <Col xs={6}>
            <p className="m-y-0 small">
            ...
            <p className="text-white h3 m-y-0">2</p>
          </Col>
          <Col xs={12}>
            <SlimProgressBar className="m-y-1">
