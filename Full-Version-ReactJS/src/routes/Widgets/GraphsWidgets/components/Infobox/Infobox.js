      ...
      <ListGroupItem>
        <Row>
          <Col xs={6} className="text-center">
            ...
            <p className="text-white h3 m-y-0">$3,267.00</p>
          </Col>
          <Col xs={6} className="text-center">
            <p className="text-center m-y-0 small">
            ...
            <p className="text-white h3 m-y-0">$0.00</p>
          </Col>
        </Row>
      </ListGroupItem>
      <ListGroupItem className="text-uppercase small text-center">
      ...
      <ListGroupItem>
        <Row>
          <Col xs={6} className="text-center">
            ...
            <p className="text-white h3 m-y-0">$7,762.01</p>
          </Col>
          <Col xs={6} className="text-center">
            <p className="text-center m-y-0 small">
            ...
            <p className="text-white h3 m-y-0">$2,342.00</p>
          </Col>
        </Row>
      </ListGroupItem>
    </ListGroup>
