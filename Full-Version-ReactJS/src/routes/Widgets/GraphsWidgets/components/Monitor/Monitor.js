    ...
    <Grid fluid>
      <Row>
        <Col sm={4} className="text-center p-t-2">
          <Charts.SparklineDonut value={76} radius={56} innerRadius={8} />
          <h5 className="m-b-0">CPU</h5>
          <p className="small text-center">76%</p>
        </Col>
        <Col sm={4} className="text-center p-t-2">
          <Charts.SparklineDonut value={90} radius={56} innerRadius={8} />
          <h5 className="m-b-0">Drive</h5>
          <p className="small text-center">90%</p>
        </Col>
        <Col sm={4} className="text-center p-t-2">
          <Charts.SparklineDonut value={27} radius={56} innerRadius={8} />
          <h5 className="m-b-0">Memory</h5>
          <p className="small text-center">27%</p>
        </Col>
      </Row>
      <Row>
        ...
        <Col sm={12}>
          <p className="text-nowrap text-white text-center small">
            <span>21 KB/s</span> <i className="fa fa-level-down text-primary m-r-2"></i>
            <i className="fa fa-level-up text-primary"></i> <span>89 KB/s</span>
          </p>
        </Col>
      </Row>
      <Row>
