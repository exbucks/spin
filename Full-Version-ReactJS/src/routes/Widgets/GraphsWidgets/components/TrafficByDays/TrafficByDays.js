...
const TrafficByDays = (panelProps) => (
  <CollapsablePanel
    ...
    footer={
      <Row className="m-b-2">
        <Col md={3}>
          <small className="text-muted">Yearly Change</small>
          <p className="m-t-0 m-b-1 h2 f-w-300">+ 233.19</p>
          <SlimProgressBar now={60} />
        </Col>
        <Col md={3}>
          <small className="text-muted">Shares Trade</small>
          <p className="m-t-0 m-b-1 h2 f-w-300">+ 89.22 M</p>
          <SlimProgressBar now={20} />
        </Col>
        <Col md={3}>
          <small className="text-muted">Today</small>
          <p className="m-t-0 m-b-1 h2 f-w-300">+ 21.01</p>
          <SlimProgressBar now={35} />
        </Col>
        <Col md={3}>
          <small className="text-muted">Last Month</small>
          <p className="m-t-0 m-b-1 h2 f-w-300">- 9.19</p>
