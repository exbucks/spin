  ...
  >
    <ListGroup className={classes.list}>
      <ListGroupItem>
        <Row>
          <Col sm={6}>
            <span className="text-white m-r-1">81 %</span>
            Clicks
          </Col>
      ...
      <ListGroupItem>
        <Row>
          <Col sm={6}>
            <span className="text-white m-r-1">34 %</span>
            Unique Clicks
          </Col>
          <Col sm={6} className="text-right">
            98
      ...
      <ListGroupItem>
        <Row>
          <Col sm={6}>
            <span className="text-white m-r-1">52 %</span>
            Impressions
          </Col>
          <Col sm={6} className="text-right">
            67
      ...
      <ListGroupItem>
        <Row>
          <Col sm={6}>
            <span className="text-white m-r-1">23 %</span>
            Online Users
          </Col>
          <Col sm={6} className="text-right">
            9
