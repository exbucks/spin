      ...
      >
        <ListGroup className={classes.list}>
          <ListGroupItem>
            <ButtonGroup justified bsSize="small">
              <Button href="javascript:;">Daily</Button>
              <Button href="javascript:;">Weekly</Button>
              <Button href="javascript:;">Monthly</Button>
              <Button href="javascript:;">Yearly</Button>
              <Button href="javascript:;">All</Button>
            </ButtonGroup>
          </ListGroupItem>
          <ListGroupItem>
        ...
        <Table condensed fill className={classes.table}>
          <thead>
            <tr>
              <th>
                <span className="m-l-1">Stock</span>
              </th>
              <th></th>
              <th></th>
            </tr>
