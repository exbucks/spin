    ...
    <ListGroup className={classes.list}>
      <ListGroupItem>
        <p className="m-y-0 small">
          ...
          <strong className="text-uppercase">Macintosh</strong>
        </p>
        <SlimProgressBar now={60} className="m-y-1" />
        <p className="m-y-0 small text-uppercase">
          <span className="text-white">412.00 GB</span>
          {' / 700.00 GB'}
        </p>
      </ListGroupItem>
      <ListGroupItem>
        <p className="m-y-0 small">
          <i className="fa fa-hdd-o m-r-1"></i>
          <strong className="text-uppercase">Windows</strong>
        </p>
        <SlimProgressBar now={80} className="m-y-1" bsStyle="danger" />
        <p className="m-y-0 small text-uppercase">
          <span className="text-white">756.00 GB</span>
          {' / 900.00 GB'}
        </p>
      </ListGroupItem>
      <ListGroupItem>
        <p className="m-y-0 small">
          <i className="fa fa-hdd-o m-r-1"></i>
          <strong className="text-uppercase">Linux</strong>
        </p>
        <SlimProgressBar now={20} className="m-y-1" bsStyle="info" />
        <p className="m-y-0 small text-uppercase">
          <span className="text-white">127.00 GB</span>
          {' / 786.00 GB'}
        </p>
      </ListGroupItem>
    </ListGroup>
