...
const Memory = (panelProps) => (
  ...
  >
    <p className="m-b-2">
      GSkill 2 x 8 GB DDR3{' '}
      <small>
        @1333 Mhz <i className="fa fa-fw fa-info-circle"></i>
      </small>
    </p>
    ...
    <Row>
      <Col sm={4} key={uuidv4()}>
        <small>
          <i className="fa fa-fw fa-circle" style={{ color: Colors.brandCerulean }}></i> Allocated
        </small>
      ...
      <Col sm={4} key={uuidv4()}>
        <small>
          <i className="fa fa-fw fa-circle" style={{ color: Colors.brandCuriousBlue }}></i> In Cache
        </small>
      ...
      <Col sm={4} key={uuidv4()}>
        <small>
          <i className="fa fa-fw fa-circle" style={{ color: Colors.brandEndaveour }}></i> Available
        </small>
