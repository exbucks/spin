      ...
      <div>
        ...
        <Row>
          <Col md={4}>
            ...
            <Panel type="color-border-full" bsStyle="primary" header="Panel with Border Primary">
              {loremParagraph}
            </Panel>
          </Col>
          <Col md={4}>
            {panelNotice('Panel with Border Info')}
            <Panel type="color-border-full" bsStyle="info" header="Panel with Border Info">
              {loremParagraph}
            </Panel>
          </Col>
          <Col md={4}>
            {panelNotice('Panel with Border Success')}
            <Panel type="color-border-full" bsStyle="success" header="Panel with Border success">
              {loremParagraph}
            </Panel>
          </Col>
        </Row>
        ...
        <Row>
          ...
          <Col md={4}>
            ...
            <Panel type="color-border-left" bsStyle="danger" header="Panel with Border Left Danger">
              {loremParagraph}
            </Panel>
          </Col>
        </Row>
        ...
        <Row>
          <Col md={4}>
            ...
            <Panel header="Panel heading without title">{loremParagraph}</Panel>
          </Col>
          <Col md={4}>
            {panelNotice('Panel Without Heading')}
            <Panel>{loremParagraph}</Panel>
          </Col>
          <Col md={4}>
        ...
        <Row>
          <Col md={4}>
            ...
            <Panel background="default">{loremParagraph}</Panel>
          </Col>
          <Col md={4}>
            {panelNotice('Panel Heading without Title')}
            <Panel background="default" header="Panel Heading without Title">
              {loremParagraph}
            </Panel>
          </Col>
          <Col md={4}>
            {panelNotice('Panel Title')}
            <Panel background="default" header={<span>Panel Title</span>}>
              {loremParagraph}
            </Panel>
          </Col>
        </Row>
        ...
        <Row>
          <Col md={4}>
            ...
            <Panel background="default" footer="Panel Footer">
              {loremParagraph}
            </Panel>
          </Col>
          <Col md={4}>
        ...
        <Row>
          <Col md={4}>
            {panelNotice('Panel without Background')}
            <Panel borderStyle="thin" header={<span>Panel Title</span>}>
              {loremParagraph}
            </Panel>
          </Col>
          <Col md={4}>
            {panelNotice('Panel without Background 2px border')}
            <Panel borderStyle="normal" header={<span>Panel Title</span>}>
              {loremParagraph}
            </Panel>
          </Col>
          <Col md={4}>
            {panelNotice('Panel without Background 3px border')}
            <Panel borderStyle="thick" header={<span>Panel Title</span>}>
              {loremParagraph}
            </Panel>
          </Col>
        </Row>
        ...
        <Row>
          ...
          <Col md={4}>
            ...
            <Panel
              ...
              header={
                <span>
                  Panel Title <small>with Description</small>
                </span>
              }
            >
              {loremParagraph}
        ...
        <Row>
          <Col md={4}>
            ...
            <Panel background="default" fullBody header={<span>Panel with Alert Success</span>}>
              <Alert bsStyle="success" className="m-y-0" rounded={false}>
                <Media>
              ...
              <div className="panel-body">{loremParagraph}</div>
            </Panel>
          </Col>
          <Col md={4}>
            {panelNotice('Panel with Alert Info')}
            <Panel background="default" fullBody header={<span>Panel with Alert Info</span>}>
              <Alert bsStyle="info" className="m-y-0" rounded={false}>
                <Media>
                  <Media.Left align="middle">
                    <span className="fa-stack fa-lg">
          ...
          <Col md={4}>
            ...
            <Panel background="default" fullBody header={<span>Panel with Alert Warning</span>}>
              <Alert bsStyle="warning" className="m-y-0" rounded={false}>
                <Media>
                  <Media.Left align="middle">
                    <span className="fa-stack fa-lg">
        ...
        <Row>
          <Col md={4}>
            ...
            <Panel background="default" fullBody header={<span>Panel with Alert Danger</span>}>
              <Alert bsStyle="danger" className="m-y-0" rounded={false}>
                <Media>
                  <Media.Left align="middle">
                    <span className="fa-stack fa-lg">
            ...
            <Panel
              ...
              header={
                <div className="flex-space-between">
                  ...
                  <Pagination bsSize="small" items={2} activePage={1} className="m-y-0" prev next />
                </div>
              }
            >
              {loremParagraph}
                ...
                header={
                  <div className="flex-space-between">
                    ...
                    <ButtonGroup bsSize="xs">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip id="option-fullscreen">Fullscreen</Tooltip>}
                      >
                        <Button bsStyle="link">
                      ...
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip id="option-collapse">Collapse</Tooltip>}
                      >
                        <Button bsStyle="link">
                      ...
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip id="option-delete">Delete</Tooltip>}
                      >
                        <Button bsStyle="link" onClick={() => this.closePanel('gray_panel')}>
