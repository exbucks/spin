        ...
        <Col lg={12}>
          ...
          <Row>
            <Col className={classes.centerCol} md={4}>
              ...
              >
                <h2 className={classes.panelHeader}>Error 404</h2>
                <p className="text-center m-b-3">
                  Sorry but the page you are looking for ({' '}
                  <span className="text-white">{this.props.location.pathname}</span> ) was not
                  found. Try to fix the URL or use the search engine below.
                </p>
                <InputGroup>
                  <FormControl type="text" placeholder="Search pages..." />
                  <InputGroup.Button>
              ...
              <p className="text-center text-gray-light">
                ...
                <span className="text-gray-light">
                  © 2009 - 2016. Made by <i className="fa fa-fw fa-heart text-danger"></i> New
                  York, US
                </span>
              </p>
            </Col>
