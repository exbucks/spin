      ...
      <Row>
        <Col md={6}>
          <div className="p-a-3">
            ...
            <small className="text-muted">
              Invoice are issued on the date of despatch. Payment terms: Pre-orders: within 10 days
              of invoice date with 4% discount, from the 11th to the 30th day net. Re-orders:
              non-reduced stock items are payable net after 20 days.
            </small>
          </div>
        </Col>
        <Col md={6}>
          <ButtonGroup>
            <Button bsStyle="link">Credit Card</Button>
            <Button bsStyle="link">PayPal</Button>
            <Button bsStyle="link">Skrill</Button>
          </ButtonGroup>
      ...
      <Row>
        <Col md={6}>
          <div className="p-a-3">
            ...
            <p>Below is a sample page for your cart , Created using pages design UI Elementes.</p>
            <small className="text-muted">
              Below is a sample page for your cart, Created using pages design UI Elements
            </small>
        ...
        <Col md={6}>
          ...
          <dl className="row m-l-2">
            ...
            <dd className="col-sm-8">
              <div className={classes.changeBtnWrap}>
                <Button bsStyle="link">
                  <i className="fa fa-angle-left m-r-1"></i> Change
                </Button>
              </div>
            </dd>
          </dl>
          ...
          <dl className="row m-l-2">
            ...
            <dd className="col-sm-8">
              <i className="fa fa-cc-visa text-primary"></i> Visa{' '}
            </dd>
