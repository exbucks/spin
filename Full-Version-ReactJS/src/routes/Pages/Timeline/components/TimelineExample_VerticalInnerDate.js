  ...
  <Timeline itemAlignment="vertical-inner-date">
    ...
    >
      <Timeline.ItemHeader
        primaryText={
          <p>
            <Label bsStyle="danger" className="label-outline">
              Alert
            </Label>
          </p>
        }
        secondaryText={<p className="text-white">{faker.hacker.phrase()}</p>}
      />
    </Timeline.Item>
    ...
    >
      <Timeline.ItemHeader
        primaryText={
          <p>
            <Label bsStyle="warning" className="label-outline">
              Warning
            </Label>
          </p>
        }
    ...
    >
      <Timeline.ItemHeader
        primaryText={
          <p>
            <Label bsStyle="info" className="label-outline">
              Info
            </Label>
          </p>
        }
        secondaryText={<p className="text-white">15 Files Uploaded</p>}
      />
      <Timeline.ItemBody>
    ...
    >
      <Timeline.ItemHeader
        primaryText={
          <p>
            <Label bsStyle="primary" className="label-outline">
              Info
            </Label>
          </p>
        }
        secondaryText={<p className="text-white">6 users have been accepted by the Admin</p>}
      />
      <Timeline.ItemBody>
    ...
    >
      <Timeline.ItemHeader
        primaryText={
          <p>
            <Label bsStyle="success" className="label-outline">
              Success
            </Label>
          </p>
        }
    ...
    >
      <Timeline.ItemHeader
        primaryText={
          <p>
            <Label className="label-outline label-gray">Success</Label>
          </p>
        }
        secondaryText={
          <p className="text-white">
            <del>{faker.hacker.phrase()}</del>
          </p>
        }
      />
    </Timeline.Item>
