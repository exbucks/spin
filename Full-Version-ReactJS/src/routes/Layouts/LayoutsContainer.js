  ...
  render() {
      ...
      return (
        <Row>
          <Col lg={12} className="text-center">
            <h1 className="text-center m-b-2">Empty Page</h1>
            <p className="m-b-2">All layout elements disabled, with a Fluid Container only.</p>
            <a
              href="javascript:;"
              onClick={() => {
    ...
    return (
      <Row>
        <Col lg={12}>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officiis pariatur odio ab
            excepturi minus blanditiis recusandae incidunt? Earum magni ratione alias, itaque
            provident excepturi fugiat maxime enim blanditiis accusamus velit quae inventore, quia,
            totam quaerat eligendi rem nisi qui reprehenderit laboriosam.
          </p>

          <Divider>Available options</Divider>

          <Row className="m-t-2">
            <Col lg={2} md={3} sm={6}>
              <Link to="/layouts/default" className={classes.galleryLink}>
                <GalleryThumbnail src={thumbDefaultPage} active={layoutType === 'default'}>
            ...
            <Col lg={2} md={3} sm={6}>
              <Link to="/layouts/fixed" className={classes.galleryLink}>
                <GalleryThumbnail src={thumbDefaultFixed} active={layoutType === 'fixed'}>
                  <p className="m-y-0 text-center text-nowrap">
                    Default Fixed
                    <i className="fa fa-angle-right m-l-1"></i>
                  </p>
            ...
            <Col lg={2} md={3} sm={6}>
              <Link to="/layouts/without-navbar" className={classes.galleryLink}>
                <GalleryThumbnail src={thumbWithoutNavbar} active={layoutType === 'without-navbar'}>
                  <p className="m-y-0 text-center text-nowrap">
                    Without Navbar
                    <i className="fa fa-angle-right m-l-1"></i>
                  </p>
            ...
            <Col lg={2} md={3} sm={6}>
              <Link to="/layouts/without-footer" className={classes.galleryLink}>
                <GalleryThumbnail src={thumbWithoutFooter} active={layoutType === 'without-footer'}>
                  <p className="m-y-0 text-center text-nowrap">
                    Without Footer
                    <i className="fa fa-angle-right m-l-1"></i>
                  </p>
            ...
            <Col lg={2} md={3} sm={6}>
              <Link to="/layouts/footer-fixed" className={classes.galleryLink}>
                <GalleryThumbnail src={thumbFooterFixed} active={layoutType === 'footer-fixed'}>
                  <p className="m-y-0 text-center text-nowrap">
                    Footer Fixed
                    <i className="fa fa-angle-right m-l-1"></i>
                  </p>
            ...
            <Col lg={2} md={3} sm={6}>
              <Link to="/layouts/navbar" className={classes.galleryLink}>
                <GalleryThumbnail src={thumbOnlyNavbar} active={layoutType === 'navbar'}>
                  <p className="m-y-0 text-center text-nowrap">
                    Only Navbar
                    <i className="fa fa-angle-right m-l-1"></i>
                  </p>
            ...
            <Col lg={2} md={3} sm={6}>
              <Link to="/layouts/navbar-fixed" className={classes.galleryLink}>
                <GalleryThumbnail src={thumbNavbarFixed} active={layoutType === 'navbar-fixed'}>
                  <p className="m-y-0 text-center text-nowrap">
                    Navbar Fixed
                    <i className="fa fa-angle-right m-l-1"></i>
                  </p>
            ...
            <Col lg={2} md={3} sm={6}>
              <Link to="/layouts/default-full-width" className={classes.galleryLink}>
                <GalleryThumbnail src={thumbFullWidth} active={layoutType === 'default-full-width'}>
                  <p className="m-y-0 text-center text-nowrap">
                    Default Full Width
                    <i className="fa fa-angle-right m-l-1"></i>
                  </p>
            ...
            <Col lg={2} md={3} sm={6}>
              <Link to="/layouts/boxed" className={classes.galleryLink}>
                <GalleryThumbnail src={thumbBoxedLayout} active={layoutType === 'boxed'}>
                  <p className="m-y-0 text-center text-nowrap">
                    Boxed
                    <i className="fa fa-angle-right m-l-1"></i>
                  </p>
