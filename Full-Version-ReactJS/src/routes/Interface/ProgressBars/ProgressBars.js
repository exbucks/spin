          ...
          <Row>
            ...
            <Col lg={4}>
              ...
              <p>
                ...
                adding a <kbd>min-width</kbd> to the progress bar.
              </p>
              <p className="small text-uppercase m-t-2">
                <strong>Example</strong>
              </p>
          ...
          <Row>
            ...
            <Col lg={4}>
              <div>
                <h5>Animated</h5>
                <p>
                  Add <kbd>active</kbd> prop to a striped Progress Bar to animate the stripes right
                  to left. Not available in IE9 and below.
                </p>
                <p className="small text-uppercase m-t-2">
                  <strong>Example</strong>
                </p>
