    ...
    return (
      <div>
        ...
        <Row>
          <Col md={12}>
            <p>
              Bootstrap's CSS is built on Less, a preprocessor with additional functionality like
              variables, mixins, and functions for compiling CSS. Those looking to use the source
              Less files instead of our compiled CSS files can make use of the numerous variables
              and mixins we use throughout the framework.
            </p>

            <h5 className="m-t-3">Grayscale</h5>
            <p>
              Grayscale colors provide quick access to commonly used shades of black while semantic
        ...
        <Row>
          <Col md={12}>
            <h5 className="m-t-3">Custom Colors</h5>
            <p>
              Different colors used especially in charts, graphs and custom configurations for
              different buttons, panels, or sliders.
            </p>
          </Col>
        </Row>
        <Row className="m-t-3">
