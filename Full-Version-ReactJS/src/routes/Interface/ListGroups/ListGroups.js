        ...
        <Col md={12}>
          ...
          <Row>
            <Col lg={4}>
              ...
              <p>
                The most basic list group is simply an unordered list with list items, and the
                proper classes. Build upon it with the options that follow, or your own CSS as
                needed.
              </p>
            ...
            <Col lg={4}>
              ...
              <p>
                Add the badges component to any list group item and it will automatically be
              ...
              <ListGroup>
                <ListGroupItem>
                  Cras justo odio
                  <Badge bsStyle="primary">14</Badge>
                </ListGroupItem>
                <ListGroupItem>Dapibus ac facilisis in</ListGroupItem>
                <ListGroupItem>
                  Morbi leo risus
                  <Badge bsStyle="success">2</Badge>
                </ListGroupItem>
                <ListGroupItem>
                  Porta ac consectetur ac
                  <Badge bsStyle="danger">9</Badge>
                </ListGroupItem>
                <ListGroupItem>Vestibulum at eros</ListGroupItem>
              </ListGroup>
            </Col>
            <Col lg={4}>
              ...
              <p>
                Links can be used automatically inside the <kbd>ListGroup</kbd>, just add the{' '}
                <kbd>href</kbd> prop to the <kbd>ListGroupItem</kbd>s.
              </p>
              <p className="small text-uppercase m-t-2">
                <strong>Example</strong>
              </p>
              <ListGroup>
                ...
                <ListGroupItem href="javascript:;">Vestibulum at eros</ListGroupItem>
              </ListGroup>
            </Col>
          </Row>
          ...
          <Row>
            <Col lg={4}>
              ...
              <p>
                Any component/elment can ba an item as long as it has a <kbd>list-group-item</kbd>{' '}
                class on it.
              </p>
              <p className="small text-uppercase m-t-2">
                <strong>Example</strong>
              ...
              <ListGroup>
                <Button className="list-group-item">Cras justo odio</Button>
                <Button className="list-group-item">Morbi leo risus</Button>
                <Button className="list-group-item">Porta ac consectetur ac</Button>
                <Button className="list-group-item">Vestibulum at eros</Button>
              </ListGroup>
            </Col>
            <Col lg={4}>
              ...
              <ListGroup>
                ...
                <ListGroupItem href="javascript:;">Dapibus ac facilisis in</ListGroupItem>
                <ListGroupItem href="javascript:;">Morbi leo risus</ListGroupItem>
                <ListGroupItem href="javascript:;">Porta ac consectetur ac</ListGroupItem>
                <ListGroupItem href="javascript:;">Vestibulum at eros</ListGroupItem>
              </ListGroup>
            </Col>
            <Col lg={4}>
          ...
          <Row>
            <Col lg={4}>
              ...
              <p>
                Use <kbd>header</kbd> prop to add a header to a <kbd>ListGroupItem</kbd>. The
                children can be any other Components or HTML tags.
              </p>
              <p className="small text-uppercase m-t-2">
                <strong>Example</strong>
              </p>
              <ListGroup>
                <ListGroupItem header="List group item heading" href="javascript:;">
                ...
                <ListGroupItem href="javscript:;">
                  <Media>
                    ...
                    <Media.Body>
                      ...
                      <p className="small text-gray-lighter m-b-0">{faker.person.jobTitle()}</p>
                    </Media.Body>
              ...
              <ListGroup className={classes.customListGroup}>
                <ListGroupItem href="javscript:;" className="no-bg">
                  <Media>
                    ...
                    <Media.Body>
                      <p className="text-white m-b-0">borders_action_items_bandwidth.skd</p>
                ...
                <ListGroupItem href="javscript:;" className="no-bg">
                  <Media>
                    ...
                    <Media.Body>
                      <p className="text-white m-b-0">books_frozen_australian_dollar.afp</p>
                      <span className="small">
                        by {`${faker.person.firstName()} ${faker.person.lastName()}`}
                        <span className="text-muted"> · </span>
                        {`${faker.finance.amount()} Kb`}
                ...
                <ListGroupItem href="javscript:;" className="no-bg">
                  <Media>
                    ...
                    <Media.Body>
                      <p className="text-white m-b-0">tasty_soft_mouse.txt</p>
                      <span className="small">
                        by {`${faker.person.firstName()} ${faker.person.lastName()}`}
                        <span className="text-muted"> · </span>
                        {`${faker.finance.amount()} Kb`}
                ...
                <ListGroupItem href="javscript:;" className="no-bg">
                  <Media>
                    ...
                    <Media.Body>
                      <p className="text-white m-b-0">belize_connect_soap.hps</p>
                      <span className="small">
                        by {`${faker.person.firstName()} ${faker.person.lastName()}`}
                        <span className="text-muted"> · </span>
                        {`${faker.finance.amount()} Kb`}
