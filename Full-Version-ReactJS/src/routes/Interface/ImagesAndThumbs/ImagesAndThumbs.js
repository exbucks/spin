    ...
    return (
      <Row>
        <Col lg={12}>
          <h4>Images Shapes</h4>
          <p>
            Use the <kbd>Image</kbd> component to easily render images with placeholders
          </p>
          <p className="small text-uppercase m-t-2">
            <strong>Examples</strong>
          </p>
          <Image height={140} width={140} shape="rounded" className="m-r-1" />
          <Image height={140} width={140} shape="circle" className="m-r-1" />
          ...
          <p>
            ...
            images, videos, text, and more. If you're looking for Pinterest-like presentation of
            thumbnails of varying heights and/or widths, you'll need to use a third-party plugin
            such as Masonry, Isotope, or Salvattore.
          </p>
          <p className="small text-uppercase m-t-2">
            <strong>Examples</strong>
          </p>
