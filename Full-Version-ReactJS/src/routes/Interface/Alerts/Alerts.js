        ...
        <Col lg={12}>
          ...
          <Row>
            <Col lg={6}>
              <h5>Examples</h5>
              <p>
                Wrap any text in an <kbd>Alert</kbd> component and set <kbd>bsStyle</kbd> to set a
              ...
              <Alert bsStyle="success" noBackground>
                <strong className="text-white">Well Done!</strong> You successfully read this
                important alert message.
              </Alert>
              <Alert bsStyle="info" noBackground>
                <strong className="text-white">Heads Up!</strong> This alert needs your attention,
                but it's not super important.
              </Alert>
              <Alert bsStyle="warning" noBackground>
                <strong className="text-white">Warning!</strong> Better check yourself, you're not
                looking too good.
              </Alert>
              <Alert bsStyle="danger" noBackground>
                <strong className="text-white">Oh Snap!</strong> Change a few things up and try
                submitting again.
              </Alert>
            ...
            <Col lg={6}>
              ...
              {this.state.disAlert1 && (
                <Alert
                  bsStyle="success"
                  noBackground
                  onDismiss={() => this.setState({ disAlert1: false })}
                >
                  <strong className="text-white">Well Done!</strong> You successfully read this
                  important alert message.
                </Alert>
              ...
              {this.state.disAlert2 && (
                <Alert
                  bsStyle="info"
                  noBackground
                  onDismiss={() => this.setState({ disAlert2: false })}
                >
                  <strong className="text-white">Heads Up!</strong> This alert needs your attention,
                  but it's not super important.
                </Alert>
              ...
              {this.state.disAlert3 && (
                <Alert
                  bsStyle="warning"
                  noBackground
                  onDismiss={() => this.setState({ disAlert3: false })}
                >
                  <strong className="text-white">Warning!</strong> Better check yourself, you're not
                  looking too good.
                </Alert>
              ...
              {this.state.disAlert4 && (
                <Alert
                  bsStyle="danger"
                  noBackground
                  onDismiss={() => this.setState({ disAlert4: false })}
                >
                  <strong className="text-white">Oh Snap!</strong> Change a few things up and try
                  submitting again.
                </Alert>
          ...
          <Row>
            <Col lg={6}>
              ...
              <Alert bsStyle="success">
                <h4>Well done!</h4>
                <p className="m-b-1">You successfully read this important alert message.</p>
              ...
              <Alert bsStyle="warning">
                <h4>Warning!</h4>
                <p className="m-b-1">Better check yourself, you're not looking too good.</p>
              ...
              <Alert bsStyle="danger">
                <h4>Oh Snap!</h4>
                <p className="m-b-1">Change a few things up and try submitting again.</p>
            ...
            <Col lg={6}>
              ...
              {this.state.disAlert9 ? (
                <Alert
                  bsStyle="success"
                  noBackground
                  onDismiss={() => this.setState({ disAlert9: false })}
                >
              ...
              {this.state.disAlert10 ? (
                <Alert
                  bsStyle="info"
                  noBackground
                  onDismiss={() => this.setState({ disAlert10: false })}
                >
              ...
              {this.state.disAlert11 ? (
                <Alert
                  bsStyle="warning"
                  noBackground
                  onDismiss={() => this.setState({ disAlert11: false })}
                >
              ...
              {this.state.disAlert12 ? (
                <Alert
                  bsStyle="danger"
                  noBackground
                  onDismiss={() => this.setState({ disAlert12: false })}
                >
