      ...
      <Row>
        <Col lg={12}>
          ...
          <p>
            ...
            data-attributes for local title storage. Tooltips with zero-length titles are never
            displayed.
          </p>
          ...
          <Panel>
            ...
            <OverlayTrigger
              placement="top"
              overlay={<Tooltip id="first-tooltip">Tooltip on top</Tooltip>}
            >
              <a href="javascript: void(0)">you probably</a>
            </OverlayTrigger>
            ...
            <OverlayTrigger
              placement="top"
              overlay={<Tooltip id="second-tooltip">Tooltip on top</Tooltip>}
            >
              <a href="javascript: void(0)">have a</a>
            </OverlayTrigger>
            ...
            <OverlayTrigger
              placement="top"
              overlay={<Tooltip id="third-tooltip">Tooltip on top</Tooltip>}
            >
              <a href="javascript: void(0)">whatever keytar</a>
            </OverlayTrigger>
            {`, scenester farm-to-table banksy Austin `}
            <OverlayTrigger
              placement="top"
              overlay={<Tooltip id="fourth-tooltip">Tooltip on top</Tooltip>}
            >
          ...
          <p>
            All 22 colors are available. Just to add to the <kbd>bsStyle</kbd> prop with an
          ...
          <Panel>
            <div className="bs-example-tooltip text-center">
              ...
              <Tooltip
                ...
                className="in"
                bsStyle="success"
                id="tooltip-color-example-bottom"
              >
              ...
              <Tooltip
                ...
                className="in"
                bsStyle="warning"
                id="tooltip-color-example-right"
              >
          ...
          <p>
            Set the <kbd>placement</kbd> property on the <kbd>Tooltip</kbd> or{' '}
            <kbd>OverlayTrigger</kbd> to change the relative position of the tooltip.
          </p>
          <p className="small text-uppercase m-t-2">
            <strong>Example</strong>
          </p>
          <Panel>
            <div className="bs-example-tooltip text-center">
              <OverlayTrigger
                placement="left"
                overlay={<Tooltip id="tooltip-direction-left">Tooltip on Left</Tooltip>}
              >
                <Button>Tooltip on Left</Button>
              </OverlayTrigger>{' '}
              <OverlayTrigger
                placement="top"
                overlay={<Tooltip id="tooltip-direction-top">Tooltip on Top</Tooltip>}
              >
                <Button>Tooltip on Top</Button>
              </OverlayTrigger>{' '}
              <OverlayTrigger
                placement="bottom"
                overlay={<Tooltip id="tooltip-direction-bottom">Tooltip on Bottom</Tooltip>}
              >
                <Button>Tooltip on Bottom</Button>
              </OverlayTrigger>{' '}
              <OverlayTrigger
                placement="right"
                overlay={<Tooltip id="tooltip-direction-right">Tooltip on Right</Tooltip>}
              >
          ...
          <p>
            ...
            secondary information. Popovers whose both title and content are zero-length are never
            displayed.
          </p>
          ...
          <Panel>
            <div className="bs-example bs-example-popover">
              <Popover id="popover-basic-top" placement="top" title="Popover Top">
                Sed posuere consectetur est at lobortis. Aenean eu leo quam. Pellentesque ornare sem
                lacinia quam venenatis vestibulum.
              </Popover>
              <Popover id="popover-basic-right" placement="right" title="Popover Right">
                Sed posuere consectetur est at lobortis. Aenean eu leo quam. Pellentesque ornare sem
                lacinia quam venenatis vestibulum.
              </Popover>
              <Popover id="popover-basic-bottom" placement="bottom" title="Popover Bottom">
                Sed posuere consectetur est at lobortis. Aenean eu leo quam. Pellentesque ornare sem
                lacinia quam venenatis vestibulum.
              </Popover>
              <Popover id="popover-basic-left" placement="left" title="Popover Left">
                Sed posuere consectetur est at lobortis. Aenean eu leo quam. Pellentesque ornare sem
                lacinia quam venenatis vestibulum.
              </Popover>
            </div>
          ...
          <h5 className="m-t-3">Color Versions</h5>
          <p>
            All 22 colors are available, just add <kbd>bsStyle</kbd> prop and set it to appropriate
            brand color.
          </p>
          <p className="small text-uppercase m-t-2">
            <strong>Examples</strong>
          ...
          <h5 className="m-t-3">Four directions</h5>
          <p>
            Four options are available for positioning. Use the <kbd>placement</kbd> prop on the{' '}
            <kbd>OverlayTrigger</kbd> component for this.
          </p>
          <p className="small text-uppercase m-t-2">
            <strong>Examples</strong>
          </p>
          <Panel>
            <div className="bs-example-tooltip text-center">
              <OverlayTrigger
                ...
                trigger="click"
                overlay={
                  <Popover id="popover-placement-left">
              ...
              <OverlayTrigger
                ...
                trigger="click"
                overlay={
                  <Popover id="popover-placement-bottom">
                    Vivamus sagittis lacus vel augue laoreet rutrum faucibus.
                  </Popover>
                }
              >
              ...
              <OverlayTrigger
                ...
                trigger="click"
                overlay={
                  <Popover id="popover-placement-right">
                    Vivamus sagittis lacus vel augue laoreet rutrum faucibus.
                  </Popover>
                }
              >
