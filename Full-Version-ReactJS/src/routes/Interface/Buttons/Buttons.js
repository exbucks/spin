    ...
    return (
      <Row>
        <Col lg={12}>
          ...
          <p>
            Use the button component to add a button and style it using the <kbd>bsStyle</kbd>{' '}
            property.
          </p>
          ...
          <Button bsStyle="custom" customColor={Colors.brandCerulean}>
            Cerulean
          </Button>
          &nbsp;
          <Button bsStyle="custom" customColor={Colors.brandCuriousBlue}>
            Curious Blue
          </Button>
          &nbsp;
          <Button bsStyle="custom" customColor={Colors.brandEndaveour}>
            Endaveour
          </Button>
          &nbsp;
          <Button bsStyle="custom" customColor={Colors.brandMinsk}>
            Minsk
          </Button>
          &nbsp;
          <Button bsStyle="custom" customColor={Colors.brandEminence}>
            Eminence
          </Button>
          &nbsp;
          <Button bsStyle="custom" customColor={Colors.brandVioletEggplant}>
            Violet Eggplant
          </Button>
          &nbsp;
          <Button bsStyle="custom" customColor={Colors.brandDodgerBlue}>
            Dodger Blue
          </Button>
          &nbsp;
          ...
          &nbsp;
          <Button bsStyle="custom" customColor={Colors.brandPerfume}>
            Perfume
          </Button>
          &nbsp;
          <p className="small text-uppercase m-t-2">
          ...
          <Button bsStyle="custom" customColor={Colors.grayDarker}>
            Gray Darker
          </Button>
          &nbsp;
          <Button bsStyle="custom" customColor={Colors.grayDark}>
            Gray Dark
          </Button>
          &nbsp;
          <Button bsStyle="custom" customColor={Colors.gray}>
            Gray
          </Button>
          &nbsp;
          <Button bsStyle="custom" customColor={Colors.grayLight}>
            Gray Light
          </Button>
          &nbsp;
          <Button bsStyle="custom" customColor={Colors.grayLighter}>
            Gray Lighter
          </Button>
          &nbsp;
          {/*-----------Outline-------------*/}
          ...
          <p>
            To an existing button, add a property called <kbd>outline</kbd>
          </p>
          <p className="small text-uppercase m-t-2">
          ...
          <Button bsStyle="success" outline>
            Success
          </Button>{' '}
          <Button bsStyle="info" outline>
            Info
          </Button>{' '}
          <Button bsStyle="warning" outline>
            Warning
          </Button>{' '}
          <Button bsStyle="danger" outline>
            Danger
          </Button>{' '}
          <p className="small text-uppercase m-t-2">
            <strong>Examples Custom Colors Outline</strong>
          </p>
          <Button bsStyle="custom" customColor={Colors.brandCerulean} outline>
            Cerulean
          </Button>
          &nbsp;
          <Button bsStyle="custom" customColor={Colors.brandCuriousBlue} outline>
            Curious Blue
          </Button>
          &nbsp;
          <Button bsStyle="custom" customColor={Colors.brandEndaveour} outline>
            Endaveour
          </Button>
          &nbsp;
          <Button bsStyle="custom" customColor={Colors.brandMinsk} outline>
            Minsk
          </Button>
          &nbsp;
          <Button bsStyle="custom" customColor={Colors.brandEminence} outline>
            Eminence
          </Button>
          &nbsp;
          <Button bsStyle="custom" customColor={Colors.brandVioletEggplant} outline>
            Violet Eggplant
          </Button>
          &nbsp;
          <Button bsStyle="custom" customColor={Colors.brandDodgerBlue} outline>
            Dodger Blue
          </Button>
          &nbsp;
          <Button bsStyle="custom" customColor={Colors.brandHeliotrope} outline>
            Heliotrope
          </Button>
          &nbsp;
          <Button bsStyle="custom" customColor={Colors.brandPerfume} outline>
            Perfume
          </Button>
          &nbsp;
          {/*-----------Sizes-------------*/}
          ...
          <Row>
            <Col lg={4}>
              <p>
                Fancy larger or smaller buttons? Add property <kbd>size=</kbd> <kbd>'lg'</kbd>,{' '}
                <kbd>'sm'</kbd>, or <kbd>'xs'</kbd> for additional sizes.
              </p>
              <p className="small text-uppercase m-t-2">
          ...
          <p>
            ...
            when active. To set a buttons active state simply set the components <kbd>active</kbd>{' '}
            prop.
          </p>
          <Row>
            <Col lg={4}>
              <h5 className="m-t-3">Button Component</h5>
              <p>
                The <kbd>active</kbd> prop can be added to a <kbd>Button</kbd> componennt so it will
            ...
            <Col lg={4}>
              <h5 className="m-t-3">Disabled State</h5>
              <p>
          ...
          <Row>
            <Col lg={4}>
              <h5>Sizing</h5>
              <p>
                Instead of adding a <kbd>size</kbd> prop to each button, you can wrap them in a{' '}
                <kbd>ButtonGroup</kbd> component and unify all the child button sizes to one.
              </p>
              <p className="small text-uppercase m-t-2">
                <strong>Examples</strong>
              </p>
            ...
            <Col lg={4}>
              ...
              <p>
                Make a group of buttons stretch at equal sizes to span the entire width of its
            ...
            <Col lg={4}>
              ...
              <p>
                Make a set of buttons appear vertically stacked rather than horizontally. Split
          ...
          <Row>
            ...
            <Col lg={4}>
              ...
              <p>
                Combine sets of <kbd>ButtonGroup</kbd> components in <kbd>ToolbarGroup</kbd> for
                more complex groups.
              </p>
              <p className="small text-uppercase m-t-2">
                <strong>Examples</strong>
            ...
            <Col lg={4}>
              ...
              <p>
                You can place other button types within the <kbd>ButtonGroup</kbd> like{' '}
                <kbd>DropdownButton</kbd>s.
              </p>
              <p className="small text-uppercase m-t-2">
                <strong>Examples</strong>
              </p>
          ...
          <Row>
            <Col lg={3}>
              <h5>Single Button</h5>
              <p>Turn a button into a dropdown toggle by changing button.</p>
              <p className="small text-uppercase m-t-2">
                <strong>Examples</strong>
              </p>
          ...
          <p>
            You can make the buttons act like checkboxes or radios by attaching React state to them.
          </p>
          <Row>
            <Col md={4}>
              <p className="small text-uppercase m-t-2">
          ...
          <Row>
            <Col lg={4}>
              ...
              <p>Attach state to create loading buttons.</p>
              <p className="small text-uppercase m-t-2">
                <strong>Example</strong>
              </p>
              <Button
            ...
            <Col lg={4}>
              ...
              <p>Create Toggle buttons by attaching React State</p>
              <p className="small text-uppercase m-t-2">
                <strong>Example</strong>
              </p>
              <Button
