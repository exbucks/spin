...
class TypographyContainer extends RoutedComponent {
  ...
  render() {
    return (
      <Row>
        <Col md={12}>
          <h5 className="m-b-1">Lead Body Copy</h5>
          <p>
          ...
          <p className="lead">
            ...
            parturient montes, nascetur ridiculus mus. Nulla vitae elit libero, a pharetra augue.
            Cras justo odio, dapibus ac facilisis in, egestas eget quam.
          </p>

          <h5 className="m-t-3 m-b-1">Body Copy</h5>
          <p>
            Bootstrap's global default <kbd>font-size</kbd> is <strong>14px</strong>, with a
            line-height of <strong>1.428</strong>. This is applied to the <kbd>&lt;body&gt;</kbd>{' '}
            and all paragraphs. In addition, <kbd>&lt;p&gt;</kbd> (paragraphs) receive a bottom
          ...
          <p>
            ...
            vehicula. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur
            ridiculus mus. Donec ullamcorper nulla non metus auctor fringilla. Duis mollis, est non
            commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Donec
            ullamcorper nulla non metus auctor fringilla. Maecenas sed diam eget risus varius
            blandit sit amet non magna. Donec id elit non mi porta gravida at eget metus. Duis
            mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec
            elit.
          </p>

          <h5 className="m-t-3 m-b-1">Headings</h5>
          <p>
            All HTML headings, <kbd>&lt;h1&gt;</kbd> through <kbd>&lt;h6&gt;</kbd>, are available.
            .h1 through <kbd>.h6</kbd> classes are also available, for when you want to match the
          ...
          <Row>
            <Col md={6}>
              ...
              <h1 className="m-t-1">h1. Bootstrap heading</h1>
          ...
          <h5 className="m-t-3 m-b-1">Page Header</h5>
          <p>
            A simple shell for an <kbd>.h1</kbd> to appropriately space out and segment sections of
            content on a page. It can utilize the <kbd>.h1</kbd>'s default <kbd>.small</kbd>{' '}
          ...
          <h5 className="m-t-3 m-b-1">HR Headers</h5>
          <p>Very good to use especially for headers in tablet or mobile. 3 examples below.</p>
          <p className="small text-uppercase m-b-0 m-t-2">
            <strong>Examples</strong>
          </p>
          <Row>
            <Col lg={4}>
              <Divider textPosition="left">HR Text Left</Divider>
            </Col>
            <Col lg={4}>
              <Divider textPosition="center">HR Text Center</Divider>
            </Col>
            <Col lg={4}>
              <Divider textPosition="right">HR Text Right</Divider>
            </Col>
          </Row>

          <h5 className="m-t-3 m-b-1">Display Headings</h5>
          <p>
          ...
          <h5 className="m-t-3 m-b-1">Contextual colors</h5>
          <p>
          ...
          <h5 className="m-t-3 m-b-2">Inline Body Text</h5>
          <Row>
            <Col md={6}>
              <p>
            ...
            <Col md={6}>
              <p>
                ...
                <span>
                  The following snippet of text is rendered as <strong>bold text.</strong>
                </span>
              </p>
              <p>
              ...
              <p>
                ...
                <span className="text-lowercase">Lowercased text.</span> /{' '}
                <span className="text-uppercase">Uppercased text.</span> /{' '}
                <span className="text-capitalize">Capitalized text.</span>
              </p>
            </Col>
          </Row>

          <h5 className="m-t-3 m-b-2">Descriptions</h5>
          <Row>
            <Col lg={6}>
              <dl>
          ...
          <h5 className="m-t-3 m-b-2">Blockquotes</h5>
          <Row>
            <Col lg={4} md={12}>
              <blockquote>
                <p>
          ...
          <h5 className="m-t-3 m-b-2">Code</h5>
          <Row>
            <Col lg={4} md={12}>
              <pre>
            ...
            <Col lg={4} md={12}>
              <p>
                To switch directories, type <kbd>cd</kbd> followed by the name of the directory. To
                edit settings, press{' '}
                <kbd>
