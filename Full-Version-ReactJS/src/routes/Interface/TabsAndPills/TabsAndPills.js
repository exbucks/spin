  ...
  render() {
    return (
      <Row>
        <Col lg={12}>
          <p>
            Navs can by used by adding the <kbd>Nav</kbd> component. You can change its style by
            setting different props.
          </p>
          ...
          <Row className="m-t-2">
            <Col lg={6}>
              <h5>Tabs</h5>
              <p className="m-b-2">
                Tabs are created by adding <kbd>Tabs</kbd> component with nested <kbd>Tab</kbd>{' '}
                children inside.
              </p>
            ...
            <Col lg={6}>
              ...
              <p className="m-b-2">
                They can be justified to take the full width of their parent. Use the{' '}
                <kbd>justified</kbd> prop.
              </p>
              <p className="text-muted text-uppercase small">
                <strong>Example</strong>
              </p>
          ...
          <Row className="m-t-3">
            <Col lg={6}>
              ...
              <Nav bsStyle="tabs" activeKey="1">
                ...
                <NavItem eventKey="2" title="Profile">
                  Profile
                </NavItem>
          ...
          <Row className="m-t-3">
            ...
            <Col lg={3}>
              <h5>Pills Stacked</h5>
              <p className="m-b-2">
                Pills can abe vertically stacked, just add <kbd>stacked</kbd> prop to the{' '}
                <kbd>Nav</kbd> component.
              </p>
              <p className="text-muted text-uppercase small">
                <strong>Example</strong>
              </p>
