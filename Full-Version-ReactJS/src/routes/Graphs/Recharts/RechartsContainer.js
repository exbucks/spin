    ...
    return (
      <div>
        <p>
          ...
          library is to help you to write charts in React applications without any pain. Simply
          deploy with React components Native SVG support, lightweight depending only on some D3
          submodules Declarative components, components of charts are purely presentational
        </p>
        <Row className="m-t-2">
          <Col lg={6}>
