      ...
      <Row>
        <Col lg={12}>
          <p className="m-b-3">
            ...
            classes for easy layout options, as well as powerful mixins for generating more semantic
            layouts.
          </p>
          ...
          <p>
            Using a single set of <kbd>Col</kbd> components, you can create a basic grid system that
          ...
          <p>
            ...
            medium device grid props by adding <kbd>xs=</kbd> <kbd>md=</kbd> to your columns. See
          ...
          <p>
            ...
            breakpoints, your columns don't clear quite right as one is taller than the other. To
            fix that, use the <kbd>Clearfix</kbd> utility component.
          </p>
          ...
          <p>
            To nest your content with the default grid, add a new <kbd>Row</kbd> component and set
            of <kbd>Col</kbd> columns within an existing <kbd>Col</kbd> column. Nested rows should
            include a set of columns that add up to 12 or fewer (it is not required that you use all
          ...
          <p>
            Easily change the order of our built-in grid columns with <kbd>mdPush=*</kbd> and{' '}
            <kbd>mdPull=*</kbd> modifier props.
          </p>
          <Row className="show-grid">
            <Col md={9} mdPush={3}>
