...
const simplifyChildrenArray = (reactChildren) =>
  _.map(reactChildren, (child) => ({ ...child, key: child.key.replace(/\.\$/g, '') }));
...
class Row extends React.Component {
        ...
        currentLayout.push({
          ...
          x:
            typeof child.props[`${colName}X`] !== 'undefined'
              ...
              : x + childWidthNormalized > colValue
              ? 0
              : x,
          y:
  ...
  getColumnSizes(columnsSizes = this.props.columnsSizes) {
    return columnsSizes && !_.isEmpty(columnsSizes) ? columnsSizes : Row.defaultProps.columnsSizes;
  }
