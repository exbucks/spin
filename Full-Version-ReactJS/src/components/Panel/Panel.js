...
class Panel extends React.Component {
  ...
  adjustPanelStructure(maxHeight = false, fullBody = false) {
    ...
    parentElement.style.background = isCustomColor(this.props.background) && this.props.background;
    if (headerElement) {
  ...
  render() {
    ...
    const panelStyle = typeof maxHeight !== 'undefined' ? { ...style, overflow: 'hidden' } : style;
